...
public class WSwipeBackLayout extends FrameLayout {
     ...
     */
    private List<WSwipebackListener> mListeners;
    ...
    public WSwipeBackLayout(Context context) {
        this(context, null);
    }

    public WSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = ViewDragHelper.create(this, new ViewDragCallback());

        setShadow(R.drawable.shadow_lefts);
     ...
     */
    @Deprecated
    public void setSwipeListener(WSwipebackListener listener) {
     ...
     * @param listener the swipe listener to attach to this view
     */
    public void addSwipeListener(WSwipebackListener listener) {
        if (mListeners == null) {
            mListeners = new ArrayList<WSwipebackListener>();
        }
     ...
     * @param listener
     */
    public void removeSwipeListener(WSwipebackListener listener) {
        if (mListeners == null) {
            return;
        }
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (ret) {
                if (mListeners != null && !mListeners.isEmpty()) {
                    for (WSwipebackListener listener : mListeners) {
